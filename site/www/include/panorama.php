<div class="grid_12">
  <div class="slider">
    <ul class="items">
      ...
      <li>
        <img src="images/kaleessi/panorama/french-manucure.jpg" alt="">
        <div class="banner slider-text"><strong>French Manucure</strong></div>
      </li>
      <li>
        <img src="images/kaleessi/panorama/nail-art.jpg" alt="">
        <div class="banner slider-text"><strong>Nail Art</strong></div>
      </li>
      <li>
