...
<head>
    ...
    <title>Kaleessi - Pose d'ongles et prothésie ongulaire à Mâcon - Descriptions des prestations de prothésie ongulaire</title>
    <meta name="description" content="Kaleessi, salon de pose d'ongles sur Mâcon. Présentations de la pose d'ongle et de la prothésie ongulaire." />
    ...
    <!--==============================content================================-->
      <section id="content">
        <div class="container_12">
          <?php require('include/prothesie.php'); ?>
          <div class="clear"></div>
        </div>
      </section> 
    <!--==============================footer=================================-->
